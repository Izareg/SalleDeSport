...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div class="lopez col-md-6 fonddiv text-center ">
	<h1 class="nom">Les propriétaires de Biscotto 3000</h1>
	<p><img src="img/notrefamille.jpg"></p>
<h4>Si t'aimes pas notre salle et la castagne: MANGE TES MORTS</h4>
<h5>Ps : interdit aux Lopez de Clermont-Ferrand</h5>
	</div>
				<div class="col-md-6 fonddiv text-center">
